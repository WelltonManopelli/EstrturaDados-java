...
public class ListaDuplamenteEncadeada<T> {
    ...
    public void add(int index, T elemento){
        ...
        if(novoNo.getNoProximo() != null){
            ...
            //noAuxiliar = novoNo.getNoProximo
        ...
        if(index == 0){
            ...
            /* getNoPrevio() chama o objeto anterior e dps acessa o metodo setProximo() desse objeto anterior,
            * passando o parametro do novo nó, no objeto anterior*/
